...
--default
-- weather_widget({
--     api_key='c22e59bea99d2e1aa94d1e9ae5e4599f',
...
theme.weather = lain.widget.weather({
    city_id = YOUR_CITY_CODE, -- placeholder (Belgium)
...
-- local weather_widget = require("awesome-wm-widgets.weather_widget.weather")
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            -- arrow("alpha", "#889FA7"),
            -- wibox.container.background(wibox.container.margin(wibox.widget { weather_widget, theme.weather_widget, layout = wibox.layout.align.horizontal }, 3, 6), "#889FA7"),
            -- weather_widget({
            --     api_key='c22e59bea99d2e1aa94d1e9ae5e4599f',
            --     -- coordinates = {45.5017, -73.5673},
            -- }),
